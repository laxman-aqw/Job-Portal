  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300 ease-in-out">
      ...
      <div className="flex gap-4">
        <button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-all duration-300 cursor-pointer">
          Apply Now
        </button>
        <button className="border border-gray-300 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-100 transition-all duration-300 cursor-pointer">
          Learn More
        </button>
      </div>
    </div>
